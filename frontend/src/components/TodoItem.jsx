...
const TodoItem = ({ todo }) => {  
  ...
  const [isDeleting, setIsDeleting] = useState(false); // for delete loading  
  const [isEditingLoading, setIsEditingLoading] = useState(false); // for edit loading  
  const [isUpdating, setIsUpdating] = useState(false); // for status update loading  
    ...
    >  
      ...
      <div className="todo-item-details">  
        ...
        <div className="todo-action">  
          ...
          <button className="delete-btn" onClick={() => handleDelete(todo._id)} disabled={isDeleting}>  
      ...
      {isEditing && (  
        <div className="editing">  
          ...
          <div className="todo-action">  
            <button className="save-btn" onClick={() => handleEdit(todo._id)} disabled={isEditingLoading}>  
              {isEditingLoading ? "Saving..." : "Save"}  
            </button>  
            <button className="cancel-btn" onClick={() => setIsEditing(false)} disabled={isEditingLoading}>  
              Cancel  
            </button>  
          </div>  
        </div>  
